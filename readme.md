<h3>1) Created a Docker file with python base image,copying and installing requirements.txt and then command for running the server by binding it to port 8000</h3>
